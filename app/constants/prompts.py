QUERY_GENERATOR_SYSTEM_PROMPT = (
    ...
    "7. CRITICAL: For status columns and all exact-value columns, ALWAYS use = not LIKE. "
    "The status column contains exact values: 'pending', 'confirmed', 'shipped', 'delivered', 'cancelled'. "
    "NEVER use LIKE '%delivered%' — always use WHERE o.status = 'delivered'.\n"
